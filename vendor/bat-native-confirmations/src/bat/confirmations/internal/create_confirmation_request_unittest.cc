...
class BatConfirmationsCreateConfirmationRequestTest : public ::testing::Test {
 protected:
  ...
  ConfirmationInfo CreateConfirmationInfoForCountryCode(
    ...
    confirmation.country_code = country_code;
...
TEST_F(BatConfirmationsCreateConfirmationRequestTest,
  ...
  const std::string credential = "";  // NOLINT

  // Act
  const std::string url = request_->BuildUrl(confirmation_id, credential);

  // Assert
  const std::string expected_url = "https://ads-serve.bravesoftware.com/v1/confirmation/d990ed8d-d739-49fb-811b-";  // NOLINT
...
TEST_F(BatConfirmationsCreateConfirmationRequestTest,
  ...
  const ConfirmationInfo confirmation =
      CreateConfirmationInfoForCountryCode("US");
...
TEST_F(BatConfirmationsCreateConfirmationRequestTest,
  ...
  const std::string unblinded_token_base64 = "PLowz2WF2eGD5zfwZjk9p76HXBLDKMq/3EAZHeG/fE2XGQ48jyte+Ve50ZlasOuYL5mwA8CU2aFMlJrt3DDgC3B1+VD/uyHPfa/+bwYRrpVH5YwNSDEydVx8S4r+BYVY";  // NOLINT
  ...
  const std::string credential =
      request_->CreateCredential(token_info, payload);

  // Assert
  const std::string expected_credential = "";  // NOLINT
...
TEST_F(BatConfirmationsCreateConfirmationRequestTest,
  ...
  // Arrange
  const ConfirmationInfo confirmation =
      CreateConfirmationInfoForCountryCode("AS");
...
TEST_F(BatConfirmationsCreateConfirmationRequestTest,
  ...
  // Arrange
  const ConfirmationInfo confirmation =
      CreateConfirmationInfoForCountryCode("KY");
...
TEST_F(BatConfirmationsCreateConfirmationRequestTest,
  ...
  // Act
  const std::string payload = request_->CreateConfirmationRequestDTO(
      confirmation, "non-release", platform);

  // Assert
  const std::string expected_payload = base::StringPrintf(R"({"blindedPaymentToken":"PI3lFqpGVFKz4TH5yEwXI3R/QntmTpUgeBaK+STiBx8=","buildChannel":"non-release","creativeInstanceId":"546fe7b0-5047-4f28-a11c-81f14edcf0f6","payload":{},"platform":"%s","type":"view"})", platform.c_str());  // NOLINT
  EXPECT_EQ(expected_payload, payload);
}
