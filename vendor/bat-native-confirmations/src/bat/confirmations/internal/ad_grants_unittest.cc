...
TEST_F(BatConfirmationsAdGrantsTest,
    InvalidJsonForDefaultBalance) {
  // Arrange
  const std::string json = "{\"type\":\"ads\",\"amount\":\"INVALID\",\"lastClaim\":\"2019-06-13T12:14:46.150Z\"}";  // NOLINT
...
TEST_F(BatConfirmationsAdGrantsTest,
    InvalidJsonForDefaultBalanceWithWrongType) {
  // Arrange
  const std::string json = "{\"type\":\"ads\",\"amount\":1,\"lastClaim\":\"2019-06-13T12:14:46.150Z\"}";  // NOLINT
  ad_grants_->SetFromJson(json);
...
TEST_F(BatConfirmationsAdGrantsTest,
    Balance) {
  // Arrange
  const std::string json = "{\"type\":\"ads\",\"amount\":\"5\",\"lastClaim\":\"2019-06-13T12:14:46.150Z\"}";  // NOLINT
  ad_grants_->SetFromJson(json);
