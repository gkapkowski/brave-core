...
void CustomizeWebUIHTMLSource(const std::string& name,
  ...
  // New tab Backgrounds
        ...
        {"will-christiansen-glacier-peak.webp",
         IDR_BRAVE_NEW_TAB_BACKGROUND13},  // NOLINT
        {"will-christiansen-ice.webp", IDR_BRAVE_NEW_TAB_BACKGROUND14},
#endif
        // private tab
        {"c168145d6bf1abf2c0322636366f7dbe.svg",
         IDR_BRAVE_PRIVATE_TAB_TOR_IMG},  // NOLINT
  ...
  base::string16 brave_welcome_page_privacy_desc = l10n_util::GetStringFUTF16(
      IDS_BRAVE_WELCOME_PAGE_PRIVACY_DESC, base::ASCIIToUTF16(kP3ALearnMoreURL),
      base::ASCIIToUTF16(kP3ASettingsLink));
  source->AddString("privacyDesc", brave_welcome_page_privacy_desc);

  static std::map<std::string, std::vector<WebUISimpleItem>> localized_strings = {  // NOLINT
      {std::string("newtab"),
       {{"adsTrackersBlocked", IDS_BRAVE_NEW_TAB_TOTAL_ADS_TRACKERS_BLOCKED},
        ...
        {"headerTorButton",
         IDS_BRAVE_PRIVATE_NEW_TAB_PRIVATE_WIONDOW_TOR_BUTTON},  // NOLINT
        ...
        {"rewardsWidgetWalletFailedButton",
         IDS_BRAVE_UI_WALLET_FAILED_BUTTON},  // NOLINT
        {"rewardsWidgetAboutRewards", IDS_REWARDS_WIDGET_ABOUT_REWARDS},
        {"rewardsWidgetServiceText", IDS_REWARDS_WIDGET_SERVICE_TEXT},
        {"rewardsWidgetEstimatedEarnings",
         IDS_REWARDS_WIDGET_ESTIMATED_EARNINGS},  // NOLINT
        {"rewardsWidgetAdsOptInDescription",
         IDS_REWARDS_WIDGET_ADS_OPT_IN_DESCRIPTION},  // NOLINT
        {"rewardsWidgetMonthlyTips", IDS_REWARDS_WIDGET_MONTHLY_TIPS},
        {"rewardsWidgetTurningOn", IDS_REWARDS_WIDGET_TURNING_ON},
        {"rewardsWidgetTurnOnRewards",
         IDS_REWARDS_WIDGET_TURN_ON_REWARDS},  // NOLINT
        {"rewardsWidgetReEnableTitle",
         IDS_REWARDS_WIDGET_REENABLE_TITLE},  // NOLINT
        {"rewardsWidgetTurnOnLearnMore",
         IDS_REWARDS_WIDGET_TURN_ON_LEARN_MORE},  // NOLINT
        {"rewardsWidgetEnableTitle", IDS_REWARDS_WIDGET_ENABLE_TITLE},
        {"rewardsWidgetEnableBrandedWallpaperTitle",
         IDS_REWARDS_WIDGET_ENABLE_BRANDED_WALLPAPER_TITLE},  // NOLINT
        {"rewardsWidgetReEnableSubTitle",
         IDS_REWARDS_WIDGET_REENABLE_SUBTITLE},  // NOLINT
        {"rewardsWidgetEnableSubTitle",
         IDS_REWARDS_WIDGET_ENABLE_SUBTITLE},  // NOLINT
        {"rewardsWidgetEnableBrandedWallpaperSubTitle",
         IDS_REWARDS_WIDGET_ENABLE_BRANDED_WALLPAPER_SUBTITLE},  // NOLINT
        {"rewardsWidgetAdsNotSupported",
         IDS_BRAVE_REWARDS_LOCAL_ADS_NOT_SUPPORTED_REGION},  // NOLINT
        {"rewardsWidgetNotificationTitle",
         IDS_REWARDS_WIDGET_NOTIFICATION_TITLE},  // NOLINT
        {"rewardsWidgetNotificationTextAds",
         IDS_REWARDS_WIDGET_NOTIFICATION_TEXT_ADS},  // NOLINT
        {"rewardsWidgetNotificationTextUGP",
         IDS_REWARDS_WIDGET_NOTIFICATION_TEXT_UGP},  // NOLINT
        {"rewardsWidgetBrandedNotificationTitle",
         IDS_REWARDS_WIDGET_BRANDED_NOTIFICATION_TITLE},  // NOLINT
        {"rewardsWidgetBrandedNotificationDescription",
         IDS_REWARDS_WIDGET_BRANDED_NOTIFICATION_DESCRIPTION},  // NOLINT
        {"rewardsWidgetBrandedNotificationHideAction",
         IDS_REWARDS_WIDGET_BRANDED_NOTIFICATION_HIDE_ACTION},  // NOLINT
        // Binance Widget
        ...
        {"binanceWidgetValidatingCreds",
         IDS_BINANCE_WIDGET_VALIDATING_CREDS},  // NOLINT
        {"binanceWidgetDisconnectTitle",
         IDS_BINANCE_WIDGET_DISCONNECT_TITLE},  // NOLINT
        {"binanceWidgetDisconnectText",
         IDS_BINANCE_WIDGET_DISCONNECT_TEXT},  // NOLINT
        {"binanceWidgetDisconnectButton",
         IDS_BINANCE_WIDGET_DISCONNECT_BUTTON},  // NOLINT
        {"binanceWidgetCancelText", IDS_BRAVE_UI_CANCEL},
        {"binanceWidgetAccountDisconnected",
         IDS_BINANCE_WIDGET_ACCOUNT_DISCONNECTED},  // NOLINT
        {"binanceWidgetConfigureButton",
         IDS_BINANCE_WIDGET_CONFIGURE_BUTTON},  // NOLINT
        ...
        {"binanceWidgetUnableToConvert",
         IDS_BINANCE_WIDGET_UNABLE_TO_CONVERT},  // NOLINT
        {"binanceWidgetRetry", IDS_BINANCE_WIDGET_RETRY},
        {"binanceWidgetInsufficientFunds",
         IDS_BINANCE_WIDGET_INSUFFICIENT_FUNDS},  // NOLINT
        {"binanceWidgetConversionFailed",
         IDS_BINANCE_WIDGET_CONVERSION_FAILED},  // NOLINT
        ...
        {"binanceWidgetAddressUnavailable",
         IDS_BINANCE_WIDGET_ADDRESS_UNAVAILABLE},  // NOLINT
        {"binanceWidgetDepositAddress", IDS_BINANCE_WIDGET_DEPOSIT_ADDRESS},
        {"binanceWidgetConfirmConversion",
         IDS_BINANCE_WIDGET_CONFIRM_CONVERSION},  // NOLINT
        ...
        {"binanceWidgetAuthInvalidCopy",
         IDS_BINANCE_WIDGET_AUTH_INVALID_COPY},  // NOLINT
      ...
      {std::string("rewards"),
       {{"adsCurrentEarnings", IDS_BRAVE_REWARDS_LOCAL_ADS_CURRENT_EARNINGS},
        ...
        {"adsDisabledTextOne",
         IDS_BRAVE_REWARDS_LOCAL_ADS_DISABLED_TEXT_ONE},  // NOLINT
        {"adsDisabledTextTwo",
         IDS_BRAVE_REWARDS_LOCAL_ADS_DISABLED_TEXT_TWO},  // NOLINT
        {"adsNotificationsReceived",
         IDS_BRAVE_REWARDS_LOCAL_ADS_NOTIFICATIONS_RECEIVED},  // NOLINT
        {"adsNotSupportedRegion",
         IDS_BRAVE_REWARDS_LOCAL_ADS_NOT_SUPPORTED_REGION},  // NOLINT
        {"adsNotSupportedDevice",
         IDS_BRAVE_REWARDS_LOCAL_ADS_NOT_SUPPORTED_DEVICE},  // NOLINT
        ...
        {"contributionDisabledText1",
         IDS_BRAVE_REWARDS_LOCAL_CONTR_DISABLED_TEXT1},  // NOLINT
        {"contributionDisabledText2",
         IDS_BRAVE_REWARDS_LOCAL_CONTR_DISABLED_TEXT2},  // NOLINT
        ...
        {"contributionShowNonVerified",
         IDS_BRAVE_REWARDS_LOCAL_CONTR_SHOW_NON_VERIFIED},  // NOLINT
        ...
        {"donationTotalDonations",
         IDS_BRAVE_REWARDS_LOCAL_DONAT_TOTAL_DONATIONS},  // NOLINT
        {"donationTotalMonthlyContribution",
         IDS_BRAVE_REWARDS_LOCAL_DONAT_TOTAL_MONTHLY_CONTRIBUTION},  // NOLINT
        ...
        {"donationDisabledText1",
         IDS_BRAVE_REWARDS_LOCAL_DONAT_DISABLED_TEXT1},  // NOLINT
        {"donationDisabledText2",
         IDS_BRAVE_REWARDS_LOCAL_DONAT_DISABLED_TEXT2},  // NOLINT
        {"donationNextDate", IDS_BRAVE_REWARDS_LOCAL_DONAT_NEXT_DATE},
        {"monthlyContributionTitle",
         IDS_BRAVE_REWARDS_LOCAL_MONTHLY_CONTRIBUTION_TITLE},  // NOLINT
        {"monthlyContributionDesc",
         IDS_BRAVE_REWARDS_LOCAL_MONTHLY_CONTRIBUTION_DESC},  // NOLINT
        {"monthlyContributionEmpty",
         IDS_BRAVE_REWARDS_LOCAL_MONTHLY_CONTRIBUTION_EMPTY},  // NOLINT
        {"monthlyContributionDisabledText",
         IDS_BRAVE_REWARDS_LOCAL_MONTHLY_CONTRIBUTION_DISABLED_TEXT},  // NOLINT
        ...
        {"walletRecoverySuccess",
         IDS_BRAVE_REWARDS_LOCAL_WALLET_RECOVERY_SUCCESS},  // NOLINT
        {"walletRestored", IDS_BRAVE_REWARDS_LOCAL_WALLET_RESTORED},
        {"walletRecoveryFail",
         IDS_BRAVE_REWARDS_LOCAL_WALLET_RECOVERY_FAIL},  // NOLINT
        ...
        {"serverNotResponding",
         IDS_BRAVE_REWARDS_LOCAL_SERVER_NOT_RESPONDING},  // NOLINT
        {"uhOh", IDS_BRAVE_REWARDS_LOCAL_UH_OH},
        {"grantGeneralErrorTitle",
         IDS_BRAVE_REWARDS_LOCAL_GENERAL_GRANT_ERROR_TITLE},  // NOLINT
        {"grantGeneralErrorButton",
         IDS_BRAVE_REWARDS_LOCAL_GENERAL_GRANT_ERROR_BUTTON},  // NOLINT
        {"grantGeneralErrorText",
         IDS_BRAVE_REWARDS_LOCAL_GENERAL_GRANT_ERROR_TEXT},  // NOLINT
        ...
        {"redirectModalErrorWallet",
         IDS_BRAVE_REWARDS_LOCAL_REDIRECT_MODAL_ERROR_WALLET},  // NOLINT
        ...
        {"autoContributeTransaction",
         IDS_BRAVE_UI_BRAVE_CONTRIBUTE_TRANSACTION},  // NOLINT
        ...
        {"braveRewardsCreatingText",
         IDS_BRAVE_UI_BRAVE_REWARDS_CREATING_TEXT},  // NOLINT
        ...
        {"markAsInappropriateChecked",
         IDS_BRAVE_UI_ADS_MARK_AS_INAPPROPRIATE_CHECKED},  // NOLINT
        ...
        {"pendingContributionRemoveAll",
         IDS_BRAVE_UI_PENDING_CONTRIBUTION_REMOVE_ALL},  // NOLINT
        ...
        {"readyToTakePartOptInText",
         IDS_BRAVE_UI_READY_TO_TAKE_PART_OPT_IN_TEXT},  // NOLINT
        ...
        {"rewardsContributeAttention",
         IDS_BRAVE_UI_REWARDS_CONTRIBUTE_ATTENTION},  // NOLINT
        {"rewardsContributeAttentionScore",
         IDS_BRAVE_UI_REWARDS_CONTRIBUTE_ATTENTION_SCORE},  // NOLINT
        ...
        {"rewardsPanelEmptyTextPoints",
         IDS_BRAVE_UI_REWARDS_PANEL_EMPTY_TEXT_POINTS},  // NOLINT
        ...
        {"walletVerificationListHeader",
         IDS_BRAVE_UI_WALLET_VERIFICATION_HEADER},  // NOLINT
      ...
      {std::string("sync"),
       {
           ...
           {"cancelDeviceSyncingButton",
            IDS_BRAVE_SYNC_SHARED_CANCEL_SYNCING_BUTTON},  // NOLINT
           {"thisSyncChain", IDS_BRAVE_SYNC_SHARED_FROM_THIS_CHAIN_PARTIAL},
           {"lookingForDevice",
            IDS_BRAVE_SYNC_SCAN_CODE_LOOKING_FOR_DEVICE_BUTTON},  // NOLINT
           ...
           {"thisDeviceRemovalDescription",
            IDS_BRAVE_SYNC_REMOVE_THIS_DEVICE_DESCRIPTION},  // NOLINT
           {"joinSyncChain",
            IDS_BRAVE_SYNC_REMOVE_THIS_DEVICE_JOIN_CHAIN_INSTRUCTIONS},  // NOLINT
                                                                         // [modal]
                                                                         // Remove
                                                                         // Other
                                                                         // Device
           {"otherDeviceRemovalDescription",
            IDS_BRAVE_SYNC_REMOVE_OTHER_DEVICE_DESCRIPTION},  // NOLINT
                                                              // [modal] Reset
                                                              // Sync
           ...
           {"scanThisCodeHowToPartial1",
            IDS_BRAVE_SYNC_SCAN_CODE_DESCRIPTION_PARTIAL_1},  // NOLINT
           {"scanThisCodeHowToPartial2",
            IDS_BRAVE_SYNC_SCAN_CODE_DESCRIPTION_PARTIAL_2},  // NOLINT
           {"scanThisCodeHowToPartial3",
            IDS_BRAVE_SYNC_SCAN_CODE_DESCRIPTION_PARTIAL_3},  // NOLINT
                                                              // [modal] View
                                                              // Code
           {"chainCode", IDS_BRAVE_SYNC_VIEW_CODE_TITLE},
           {"chainCodeDescriptionPartial1",
            IDS_BRAVE_SYNC_VIEW_CODE_DESCRIPTION_PARTIAL_1},  // NOLINT
           {"chainCodeDescriptionPartial2",
            IDS_BRAVE_SYNC_VIEW_CODE_DESCRIPTION_PARTIAL_2},  // NOLINT
           {"chainCodeDescriptionPartial3",
            IDS_BRAVE_SYNC_VIEW_CODE_DESCRIPTION_PARTIAL_3},  // NOLINT
           ...
           {"errorWrongCodeDescription",
            IDS_BRAVE_SYNC_ERROR_WRONG_CODE_DESCRIPTION},  // NOLINT
           {"errorMissingDeviceNameTitle",
            IDS_BRAVE_SYNC_ERROR_MISSING_DEVICE_NAME_TITLE},  // NOLINT
           {"errorMissingCodeTitle",
            IDS_BRAVE_SYNC_ERROR_MISSING_SYNC_CODE_TITLE},  // NOLINT
           {"errorSyncInitFailedTitle", IDS_BRAVE_SYNC_ERROR_INIT_FAILED_TITLE},
           {"errorSyncInitFailedDescription",
            IDS_BRAVE_SYNC_ERROR_INIT_FAILED_DESCRIPTION},  // NOLINT
           {"errorSyncRequiresCorrectTimeTitle",
            IDS_BRAVE_SYNC_REQUIRES_CORRECT_TIME_TITLE},  // NOLINT
           {"errorSyncRequiresCorrectTimeDescription",
            IDS_BRAVE_SYNC_REQUIRES_CORRECT_TIME_DESCRIPTION},  // NOLINT
       }},
      {std::string("adblock"),
       {
           {"additionalFiltersTitle", IDS_ADBLOCK_ADDITIONAL_FILTERS_TITLE},
           {"additionalFiltersWarning",
            IDS_ADBLOCK_ADDITIONAL_FILTERS_WARNING},  // NOLINT
           {"adsBlocked", IDS_ADBLOCK_TOTAL_ADS_BLOCKED},
           {"customFiltersTitle", IDS_ADBLOCK_CUSTOM_FILTERS_TITLE},
           {"customFiltersInstructions",
            IDS_ADBLOCK_CUSTOM_FILTERS_INSTRUCTIONS},  // NOLINT
       }},
      {std::string("tip"),
       {
           {"about", IDS_BRAVE_UI_ABOUT},
           ...
           {"rewardsBannerText1", IDS_BRAVE_UI_REWARDS_BANNER_TEXT1},
           {"rewardsBannerText2", IDS_BRAVE_UI_REWARDS_BANNER_TEXT2},
           {"rewardsBannerMonthlyText1",
            IDS_BRAVE_UI_REWARDS_BANNER_MONTHLY_TEXT1},  // NOLINT
           {"sendDonation", IDS_BRAVE_UI_SEND_DONATION},
      ...
      {std::string("checkout"),
       {
           ...
           {"addFundsButtonText",
            IDS_BRAVE_REWARDS_CHECKOUT_ADD_FUNDS_BUTTON_TEXT},
      ...
      {std::string("rewards-internals"),
       {
           ...
           {"retryStepReconcile",
            IDS_BRAVE_REWARDS_INTERNALS_RETRY_STEP_RECONCILE},  // NOLINT
           {"retryStepRegister",
            IDS_BRAVE_REWARDS_INTERNALS_RETRY_STEP_REGISTER},  // NOLINT
           ...
           {"rewardsNotEnabled",
            IDS_BRAVE_REWARDS_INTERNALS_REWARDS_NOT_ENABLED},  // NOLINT
